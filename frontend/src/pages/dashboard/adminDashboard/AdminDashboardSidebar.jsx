...
const adminSidebarSections = [
  // permission is section in simple and underscore dot item name in simple with space replaced by underscore
  {
    ...
    items: [
      { name: 'Dashboard Overview', path: '/admindashboard', icon: <FaChartBar className="h-5 w-5" />, requiredPermissions: ['dashboard_overview.dashboard_overview'] },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      { name: 'System Settings', path: '/admin/settings', icon: <FaCog className="h-5 w-5" />, requiredPermissions: ['system_management.system_settings'] },
