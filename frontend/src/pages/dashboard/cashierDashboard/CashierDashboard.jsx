    ...
    transactions.forEach(t => {
      ...
      if (ptype === 'class_payment' || ptype === 'admission_fee') {
        ...
        if (cardType) {
          ...
          else { map[cls].fullCards += 1; } // count as a class payment (full)
      ...
      if (ptype === 'class_payment') {
        ...
        if (cardType) {
          ...
          if (/full free card|100% discount/i.test(notes)) {
            ...
            console.log('✅ Free card detected (notes):', t.transaction_id, notes);
          } else if (/half free card|50% discount/i.test(notes)) {
            totals.halfCount += 1;

            totals.halfAmount += amt;

            console.log('✅ Half card detected (notes):', t.transaction_id, notes);
          } else if (amt === 0) {
            totals.freeCount += 1;
            totals.freeAmount += 0;
            console.log('✅ Free card detected (amount=0):', t.transaction_id, notes);
          } else {
          ...
          <body>
            ...
            <div class="card-breakdown">
              ...
              <div class="card">
                ...
                <div class="amount">Amount: LKR ${Number(aggregatedTotals.fullAmount || 0).toLocaleString()}</div>
              ...
              <div class="card">
                ...
                <div class="amount">Amount: LKR ${Number(aggregatedTotals.halfAmount || 0).toLocaleString()}</div>
              ...
              <div class="card">
                ...
                <div class="amount">Amount: LKR ${Number(aggregatedTotals.freeAmount || 0).toLocaleString()}</div>
            ...
            <div className="report-container">
              ...
              <div className="meta-info">
                ...
                <div className="meta-item">
                  ...
                  <strong>Report Type:</strong> {mode === 'full' ? 'Daily Full Report' : 'Daily Summary'}
  ...
  const handlePrint = () => {
    ...
    setTimeout(() => {
      ...
      if (mode === 'full') {
        ...
        const totalCollected = aggregatedByClass.reduce((sum, r) => sum + (r.totalAmount || 0), 0);
...
export default function CashierDashboard() {
  ...
  const [kpis, setKpis] = useState({ totalToday: 0, receipts: 0, pending: 0, drawer: 0, fullCardsIssued: 0, halfCardsIssued: 0, freeCardsIssued: 0 });
